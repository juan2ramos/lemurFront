    ...
    <body>
        <div class="wrapper">
            ...
            <ul id="network">
                    ...
                    <li>
                        <a title="facebook" target= "_blank" href="https://www.facebook.com/lemurstudio.com.co"><img src="images/facebook.png"></a>
                    </li>
                    <li>
                        <a title="twitter" target= "_blank" href="https://twitter.com/LemurStudio1" ><img src="images/twitter.png"></a>
                    </li>
            </ul> 
        </div>
        <!-- footer -->
